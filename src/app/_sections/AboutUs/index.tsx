...
export default async function AboutUsSection({ id, title, anchor, locale, preview }: PageSectionProps) {
  const administrators = await getAdministrators(id, locale, preview)
