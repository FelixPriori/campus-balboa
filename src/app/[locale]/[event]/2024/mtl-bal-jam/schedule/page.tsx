...
export async function generateMetadata({ params }: Props) {
  ...
  if (params.locale === 'fr') {
    return {
      ...
      description: 'Horaire de MTL BAL JAM, l\'évenement de balboa à Montréal le 21-22-23 juin 2024',
      alternates: {
        canonical: `${siteUrl}/fr/evenements/2024/mtl-bal-jam/schedule`
      },
      icons: [
    ...
    return {
      ...
      description: 'Schedule of MTL BAL JAM, a Balboa event happening in Montreal on June 21-22-23 2024',
      alternates: {
        canonical: `${siteUrl}/en/events/2024/mtl-bal-jam/schedule`
      },
      icons: [
        { rel: 'icon', url: Favicon.src }
      ],
