...
export async function generateMetadata({ params }: Props) {
  ...
  if (params.locale === 'fr') {
    return {
      ...
      description: 'Les extras du MTL BAL JAM, l\'évenement de balboa à Montréal le 21-22-23 juin 2024',
      alternates: {
    ...
    return {
      title: 'Extra | MTL BAL JAM 2024',
      description: 'Extras of the MTL BAL JAM, a Balboa event happening in Montreal on June 21-22-23 2024',
      alternates: {
