        ...
        <section className={styles.ticketsSection}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.details}>
                    ...
                    <h4>{t('fullPass')}</h4>
                    <ul>
                        {getDetails(t('ticketsDetails.full'))}
                    </ul>
                    <h4>{t('partyPass')}</h4>
                    <ul>
                        {getDetails(t('ticketsDetails.party'))}
                    </ul>
                </div>
                    ...
                    <p>
                        {
                            t.rich('subsidize.description', {
                                email: (chunks) => <a className="mbj-link" href="mailto:mtlbaljam@campusbalboa.org">{chunks}</a>
                            })
                        }
                    </p>
                </div>
                    ...
                    <p>
                        {
                            t.rich('terms.content', {
                                link: (chunks) => <a target='_blank' rel="noreferrer noopener" className="mbj-link" href={t('terms.link')}>{chunks}</a>
                            })
                        }
                    </p>
                </div>
